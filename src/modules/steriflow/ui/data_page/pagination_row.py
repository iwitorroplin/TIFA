...
from src.modules.steriflow.ui.data_page.data_presenter import DEFAULT_PAGE_SIZE
...
class PaginationRow(QWidget):
    ...
    etiqueta con el rango mostrado. `presenter` se usa solo para pintar el
    estado (`pagination_label`, `can_go_previous/next`); la navegación y el
    cambio de tamaño se delegan al orquestador vía los callbacks."""
