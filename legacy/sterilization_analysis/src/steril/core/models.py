...
from .enums import CycleStatus, FindingCode, Phase, Severity
...
class CycleResult:
    ...
    lethality_f0_min: float | None = None
    lethality_vp_min: float | None = None

    # cobertura de datos de la fase de esterilizacion (ver analysis/coverage.py):
    # cuanto de su duracion esta respaldada por lecturas de fiar.
